...
public class ConversionMoneda {
	...
	public void pARaEuro(double valor) {
		...
		cotizacion = (double)Math.round(cotizacion *100d)/100;
		JOptionPane.showMessageDialog(null,"$"+valor+" equivalen a: €"+cotizacion, "Valor convertido", JOptionPane.INFORMATION_MESSAGE);
	}//ok
	...
	public void dolarAPAr(double valor) {
		...
		cotizacion = (double)Math.round(cotizacion *100d)/100;
		JOptionPane.showMessageDialog(null,"U$D"+valor+" equivalen a: $"+cotizacion, "Valor convertido", JOptionPane.INFORMATION_MESSAGE);
	}//ok
